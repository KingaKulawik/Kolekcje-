...
//                    "Data:  październik 2018 r.\n";
    ...
    private static final String MENU =
            "    M E N U   G Ł Ó W N E  \n" +
                    ...
                    "6 - Wybierz typ kolekcji   \n" +
                    "7 - Wypisz biezaca kolekcje\n" +
                    "0 - Zakończ program        \n";
    ...
    private PersonClone currentPersonClone = null;
    private PersonBook personBook;
    private PersonBook personBookClones;
            ...
            try {
                switch (UI.enterInt(MENU + "==>> ")) {
                    ...
                    case 1:
                        ...
                        personBook.addToPersonBook(currentPerson);
                        PersonClone currentPersonClone = new PersonClone(currentPerson.getFirstName(), currentPerson.getLastName());
                        currentPersonClone.setBirthYear(currentPerson.getBirthYear());
                        currentPersonClone.setJob(currentPerson.getJob());
                        personBookClones.addToPersonBook(currentPersonClone);
                        break;
                    case 2:
                        // usunięcie danych aktualnej osoby.
                        personBook.deleteFromBook(currentPerson);
                        personBookClones.deleteFromBook(currentPerson);
                        currentPerson = null;
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        // wypisz osoby z biezacej kolekcji
                        UI.printMessage("Wersja bez nadpisanej metody equals:\n");
                        personBook.printBook();
                        UI.printMessage("Wersja z nadpisana metoda equals:\n");
                        personBookClones.printBook();
                        break;
                    case 0:
    ...
    private void chooseCollection() {
        ...
        switch (UI.enterInt(CollectionMenu + "==>> ")) {

            case 1:
                personBook = new PersonBook(new HashSet<Person>());
                personBookClones = new PersonBook(new HashSet<PersonClone>());
                break;
            case 2:
                personBook = new PersonBook(new TreeSet<Person>());
                personBookClones = new PersonBook(new TreeSet<PersonClone>());
                break;
            case 3:
                personBook = new PersonBook(new ArrayList<Person>());
                personBookClones = new PersonBook(new ArrayList<PersonClone>());
                break;
            case 4:
                personBook = new PersonBook(new LinkedList<Person>());
                personBookClones = new PersonBook(new LinkedList<PersonClone>());
                break;
